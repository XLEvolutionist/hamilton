...
Also mating behaviours also impact $N_{e}$, when males compete for females for example, and typically few males contribute gametes to the next generation, thus $N_{e}$ is lower than the consensus head count. **The Breeding Sex Ratio** can alter $N_{e}$ as such:
